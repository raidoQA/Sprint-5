...
class Locators:
    ...
    buns = (By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[1]')
    sauces = (By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[2]')
    fillings = (By.XPATH, '/html/body/div/div/main/section[1]/div[1]/div[3]')